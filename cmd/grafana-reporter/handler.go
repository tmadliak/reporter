...
import (
	...
	"github.com/tmadliak/reporter/grafana"
	"github.com/tmadliak/reporter/report"
...
func RegisterHandlers(router *mux.Router, reportServerV4, reportServerV5 ServeReportHandler) {
	...
	router.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprintf(w, "This is grafana-reporter. \nThe API endpoints are documented here: https://github.com/tmadliak/reporter#endpoint.")
	})
